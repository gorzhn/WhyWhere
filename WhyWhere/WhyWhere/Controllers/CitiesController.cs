...
namespace WhyWhere.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ImgUrl,Name,selectedCity,country")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ImgUrl,Name,selectedCity,country")] Cities cities)
        {
            if (ModelState.IsValid)
            {
