...
namespace WhyWhere.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,City,ImgUrl,Name,Description,UserId,UserRating")] Locations locations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,City,ImgUrl,Name,Description,UserId,UserRating")] Locations locations)
        {
            if (ModelState.IsValid)
            {
